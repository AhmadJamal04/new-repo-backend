APPTEX MERN Code Challenge
==================================

Hello! Your task is to create an online store where anyone can put up any random item up for sale and anyone else can buy it.
...
You should be able to finish this in 4-8 hours, you are provided with 2 days to do this. I cannot fairly judge how much time you spent on this project but please don't spend more than 12 hours on this project.
...
To be perfectly clear, We don't expect that anyone could complete all of these. This is simply a list of ideas to inspire you.

Submission
----------
Fork this repo or create a new public repo and then send the link to careers@apptex.com.pk with the subject title "MERN Challenge"

Questions / Problems / Stuck?
-----------------------------
Email at careers@apptex.com.pk
